    ...
    while (true)
    {
        ...
        if (flag = false || diff_t >= 1)
        {
            ...
            for (int i = 1; i < nLab; ++i)
            {
                ...
                if (param[cv::ConnectedComponentsTypes::CC_STAT_AREA] > GET_RANGE && param[ConnectedComponentsTypes::CC_STAT_LEFT] <= 1000)
                {
                    ...
                    tableXpoint[tdata] = param[cv::ConnectedComponentsTypes::CC_STAT_LEFT];
                    tableYpoint[tdata] = param[cv::ConnectedComponentsTypes::CC_STAT_TOP];
                    stringstream num;
                    num << tdata;
                    ...
                    {
                        cout << tdata << " "
                             << "x:" << tableXpoint[tdata] << "  y:" << tableYpoint[tdata] << endl;
                        av_count = av_count + 1;
                        range_flag = false;
                    }
                    tdata = tdata + 1;
